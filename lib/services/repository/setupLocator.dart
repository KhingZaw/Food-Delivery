...
void setupLocator() {
  ...
  locator.registerLazySingleton(() => ChatService(FirebaseFirestore.instance));
  locator.registerLazySingleton(() => UserRepository(locator<AuthService>(),
      locator<FirestoreService>(), locator<ChatService>()));
}
